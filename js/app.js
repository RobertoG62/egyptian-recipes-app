    ...
    function updateStaticText() {
        ...
        if (heroTitle) {
            heroTitle.innerHTML = i18n.getLanguage() === 'he' ?
                'המטבח <span class="text-eg-primary-light">המצרי</span>' :
                '<span class="text-eg-primary-light">Egyptian</span> Cuisine';
        }
        ...
        if (footerText) {
            footerText.innerHTML = i18n.t('footer.tagline') + ' <span class="text-eg-primary-light mx-1"><i class="fas fa-heart"></i></span>';
        }
